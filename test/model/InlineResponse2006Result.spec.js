...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse2006Result();
      });

      it('should create an instance of InlineResponse2006Result', function() {
        // TODO: update the code to test InlineResponse2006Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse2006Result);
      });
