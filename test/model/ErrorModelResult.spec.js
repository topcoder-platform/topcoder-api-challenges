...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorModelResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.ErrorModelResult();
      });

      it('should create an instance of ErrorModelResult', function() {
        // TODO: update the code to test ErrorModelResult
        expect(instance).to.be.a(ApChallengeMicroservice.ErrorModelResult);
      });
