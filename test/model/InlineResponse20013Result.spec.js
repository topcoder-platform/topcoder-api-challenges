...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20013Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse20013Result();
      });

      it('should create an instance of InlineResponse20013Result', function() {
        // TODO: update the code to test InlineResponse20013Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse20013Result);
      });
