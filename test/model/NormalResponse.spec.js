...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NormalResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.NormalResponse();
      });

      it('should create an instance of NormalResponse', function() {
        // TODO: update the code to test NormalResponse
        expect(instance).to.be.a(ApChallengeMicroservice.NormalResponse);
      });
