...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2001Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse2001Result();
      });

      it('should create an instance of InlineResponse2001Result', function() {
        // TODO: update the code to test InlineResponse2001Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse2001Result);
      });
