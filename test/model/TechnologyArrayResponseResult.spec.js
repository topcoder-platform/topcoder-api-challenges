...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TechnologyArrayResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.TechnologyArrayResponseResult();
      });

      it('should create an instance of TechnologyArrayResponseResult', function() {
        // TODO: update the code to test TechnologyArrayResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.TechnologyArrayResponseResult);
      });
