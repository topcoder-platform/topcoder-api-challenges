...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TechnologyArrayResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.TechnologyArrayResponse();
      });

      it('should create an instance of TechnologyArrayResponse', function() {
        // TODO: update the code to test TechnologyArrayResponse
        expect(instance).to.be.a(ApChallengeMicroservice.TechnologyArrayResponse);
      });
