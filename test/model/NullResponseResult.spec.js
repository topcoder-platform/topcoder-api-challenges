...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NullResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.NullResponseResult();
      });

      it('should create an instance of NullResponseResult', function() {
        // TODO: update the code to test NullResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.NullResponseResult);
      });
