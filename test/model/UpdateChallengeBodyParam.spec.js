...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateChallengeBodyParam', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.UpdateChallengeBodyParam();
      });

      it('should create an instance of UpdateChallengeBodyParam', function() {
        // TODO: update the code to test UpdateChallengeBodyParam
        expect(instance).to.be.a(ApChallengeMicroservice.UpdateChallengeBodyParam);
      });
