...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2001ResultMetadata', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse2001ResultMetadata();
      });

      it('should create an instance of InlineResponse2001ResultMetadata', function() {
        // TODO: update the code to test InlineResponse2001ResultMetadata
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse2001ResultMetadata);
      });
