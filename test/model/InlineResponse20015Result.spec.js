...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20015Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse20015Result();
      });

      it('should create an instance of InlineResponse20015Result', function() {
        // TODO: update the code to test InlineResponse20015Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse20015Result);
      });
