...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2005Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse2005Result();
      });

      it('should create an instance of InlineResponse2005Result', function() {
        // TODO: update the code to test InlineResponse2005Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse2005Result);
      });
