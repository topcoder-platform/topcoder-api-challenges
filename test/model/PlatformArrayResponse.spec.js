...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlatformArrayResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.PlatformArrayResponse();
      });

      it('should create an instance of PlatformArrayResponse', function() {
        // TODO: update the code to test PlatformArrayResponse
        expect(instance).to.be.a(ApChallengeMicroservice.PlatformArrayResponse);
      });
