...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetResourceResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.GetResourceResponse();
      });

      it('should create an instance of GetResourceResponse', function() {
        // TODO: update the code to test GetResourceResponse
        expect(instance).to.be.a(ApChallengeMicroservice.GetResourceResponse);
      });
