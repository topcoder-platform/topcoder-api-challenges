...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlatformArrayResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.PlatformArrayResponseResult();
      });

      it('should create an instance of PlatformArrayResponseResult', function() {
        // TODO: update the code to test PlatformArrayResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.PlatformArrayResponseResult);
      });
