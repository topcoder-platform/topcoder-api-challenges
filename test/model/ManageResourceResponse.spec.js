...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ManageResourceResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.ManageResourceResponse();
      });

      it('should create an instance of ManageResourceResponse', function() {
        // TODO: update the code to test ManageResourceResponse
        expect(instance).to.be.a(ApChallengeMicroservice.ManageResourceResponse);
      });
