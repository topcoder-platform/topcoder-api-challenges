...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlatformResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.PlatformResponse();
      });

      it('should create an instance of PlatformResponse', function() {
        // TODO: update the code to test PlatformResponse
        expect(instance).to.be.a(ApChallengeMicroservice.PlatformResponse);
      });
