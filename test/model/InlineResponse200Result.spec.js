...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse200Result();
      });

      it('should create an instance of InlineResponse200Result', function() {
        // TODO: update the code to test InlineResponse200Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse200Result);
      });
