...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChallengeTypeResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.ChallengeTypeResponseResult();
      });

      it('should create an instance of ChallengeTypeResponseResult', function() {
        // TODO: update the code to test ChallengeTypeResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.ChallengeTypeResponseResult);
      });
