...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NormalResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.NormalResponseResult();
      });

      it('should create an instance of NormalResponseResult', function() {
        // TODO: update the code to test NormalResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.NormalResponseResult);
      });
