  ...
  describe('(package)', function() {
    describe('InlineResponse200ResultContent', function() {
      ...
      it('should create an instance of InlineResponse200ResultContent', function() {
        // TODO: update the code to test InlineResponse200ResultContent
      ...
      it('should have the property numSubmitters (base name: "numSubmitters")', function() {
        // TODO: update the code to test the property numSubmitters
        expect(instance).to.have.property('numSubmitters');
        // expect(instance.numSubmitters).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property submissionViewable (base name: "submissionViewable")', function() {
        // TODO: update the code to test the property submissionViewable
        expect(instance).to.have.property('submissionViewable');
        // expect(instance.submissionViewable).to.be(expectedValueLiteral);
      });
