...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlatformResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.PlatformResponseResult();
      });

      it('should create an instance of PlatformResponseResult', function() {
        // TODO: update the code to test PlatformResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.PlatformResponseResult);
      });
