...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2003Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse2003Result();
      });

      it('should create an instance of InlineResponse2003Result', function() {
        // TODO: update the code to test InlineResponse2003Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse2003Result);
      });
