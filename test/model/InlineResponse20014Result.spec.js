...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20014Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse20014Result();
      });

      it('should create an instance of InlineResponse20014Result', function() {
        // TODO: update the code to test InlineResponse20014Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse20014Result);
      });
