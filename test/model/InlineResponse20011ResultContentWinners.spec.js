...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20011ResultContentWinners', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse20011ResultContentWinners();
      });

      it('should create an instance of InlineResponse20011ResultContentWinners', function() {
        // TODO: update the code to test InlineResponse20011ResultContentWinners
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse20011ResultContentWinners);
      });
