...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChallengeTypeResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.ChallengeTypeResponse();
      });

      it('should create an instance of ChallengeTypeResponse', function() {
        // TODO: update the code to test ChallengeTypeResponse
        expect(instance).to.be.a(ApChallengeMicroservice.ChallengeTypeResponse);
      });
