...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NewPlatformBodyParam', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.NewPlatformBodyParam();
      });

      it('should create an instance of NewPlatformBodyParam', function() {
        // TODO: update the code to test NewPlatformBodyParam
        expect(instance).to.be.a(ApChallengeMicroservice.NewPlatformBodyParam);
      });
