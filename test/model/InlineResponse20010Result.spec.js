...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20010Result', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.InlineResponse20010Result();
      });

      it('should create an instance of InlineResponse20010Result', function() {
        // TODO: update the code to test InlineResponse20010Result
        expect(instance).to.be.a(ApChallengeMicroservice.InlineResponse20010Result);
      });
