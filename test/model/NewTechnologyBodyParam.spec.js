...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NewTechnologyBodyParam', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.NewTechnologyBodyParam();
      });

      it('should create an instance of NewTechnologyBodyParam', function() {
        // TODO: update the code to test NewTechnologyBodyParam
        expect(instance).to.be.a(ApChallengeMicroservice.NewTechnologyBodyParam);
      });
