...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChallengeResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.ChallengeResponse();
      });

      it('should create an instance of ChallengeResponse', function() {
        // TODO: update the code to test ChallengeResponse
        expect(instance).to.be.a(ApChallengeMicroservice.ChallengeResponse);
      });
