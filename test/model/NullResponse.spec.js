...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NullResponse', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.NullResponse();
      });

      it('should create an instance of NullResponse', function() {
        // TODO: update the code to test NullResponse
        expect(instance).to.be.a(ApChallengeMicroservice.NullResponse);
      });
