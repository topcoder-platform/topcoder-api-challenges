...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChallengeResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.ChallengeResponseResult();
      });

      it('should create an instance of ChallengeResponseResult', function() {
        // TODO: update the code to test ChallengeResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.ChallengeResponseResult);
      });
