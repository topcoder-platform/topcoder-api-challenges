...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TechnologyResponseResult', function() {
      beforeEach(function() {
        instance = new ApChallengeMicroservice.TechnologyResponseResult();
      });

      it('should create an instance of TechnologyResponseResult', function() {
        // TODO: update the code to test TechnologyResponseResult
        expect(instance).to.be.a(ApChallengeMicroservice.TechnologyResponseResult);
      });
