...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ApChallengeMicroservice.ChallengeUpdate = factory(root.ApChallengeMicroservice.ApiClient, root.ApChallengeMicroservice.ChallengeFailedRegisterUsers, root.ApChallengeMicroservice.ChallengeTechnologies);
  }
}(this, function(ApiClient, ChallengeFailedRegisterUsers, ChallengeTechnologies) {
  'use strict';

  /**
   * The ChallengeUpdate model module.
   * @module model/ChallengeUpdate
   * @version 1.0.5
   */

  /**
   * Constructs a new <code>ChallengeUpdate</code>.
   * @alias module:model/ChallengeUpdate
   * @class
   */
  ...
  /**
   * Constructs a <code>ChallengeUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ChallengeUpdate} obj Optional instance to populate.
   * @return {module:model/ChallengeUpdate} The populated <code>ChallengeUpdate</code> instance.
   */
  ...
  /**
   * Challenge identifier.  This will be automatically fetched.
   * @member {Number} id
   */
  exports.prototype.id = undefined;

  /**
   * Confidentiality type. This will set terms on the challenge. Current options are public or standard_cca (NDA). Optional.
   * @member {String} confidentialityType
   */
  exports.prototype.confidentialityType = undefined;

  /**
   * Technology ID-Name-pairs. See https://api.topcoder.com/v2/data/technologies for full list. Optional.
   * @member {Array.<module:model/ChallengeTechnologies>} technologies
   */
  exports.prototype.technologies = undefined;

  /**
   * the challenge type. Optional.
   * @member {module:model/ChallengeUpdate.SubTrackEnum} subTrack
   */
  exports.prototype.subTrack = undefined;

  /**
   * The challenge name. Optional.
   * @member {String} name
   */
  exports.prototype.name = undefined;

  /**
   * The review type of the challenge.  Setting to COMMUNITY will setup a standard community review with the review board.  INTERNAL will need to be manually assigned. Optional.
   * @member {module:model/ChallengeUpdate.ReviewTypeEnum} reviewType
   */
  ...
  /**
   * The start date for checkpoint.  Set this to the same as registrationStartsAt in most cases. ISO-8601 formatted date times (YYYY-MM-DDTHH:mm:ss.sssZ). Optional.
   * @member {Date} checkpointSubmissionStartsAt
   */
  exports.prototype.checkpointSubmissionStartsAt = undefined;

  /**
   * The end of the checkpoint submission phase. ISO-8601 formatted date times (YYYY-MM-DDTHH:mm:ss.sssZ). Optional.
   * @member {Date} checkpointSubmissionEndsAt
   */
  exports.prototype.checkpointSubmissionEndsAt = undefined;

  /**
   * The end of the submission phase. ISO-8601 formatted date times (YYYY-MM-DDTHH:mm:ss.sssZ). Optional.
   * @member {Date} submissionEndsAt
   */
  exports.prototype.submissionEndsAt = undefined;

  /**
   * The info for round one.  Describe what you want submitters to deliver for their checkpoint submissions. Optional.
   * @member {String} round1Info
   */
  exports.prototype.round1Info = undefined;

  /**
   * The info for round two. Describe what you want submitters to deliver for their final submissions. Optional.
   * @member {String} round2Info
   */
  exports.prototype.round2Info = undefined;

  /**
   * Platform ID-Name-pairs.  See https://api.topcoder.com/v2/data/platforms for full list. Optional.
   * @member {Array.<module:model/ChallengeTechnologies>} platforms
   */
  exports.prototype.platforms = undefined;

  /**
   * The number of checkpoint prizes that can be awarded. Optional.
   * @member {Number} numberOfCheckpointPrizes
   */
  exports.prototype.numberOfCheckpointPrizes = undefined;

  /**
   * The checkpoint prize. This amount is the prize for EACH checkpoint winner. Optional.
   * @member {Number} checkpointPrize
   */
  exports.prototype.checkpointPrize = undefined;

  /**
   * Final deliverable type ID-Name-pairs.  Applies to design challenges. Optional.
   * @member {Array.<module:model/ChallengeTechnologies>} finalDeliverableTypes
   */
  exports.prototype.finalDeliverableTypes = undefined;

  /**
   * The prize list. Please follow standard pricing guidelines for the challenge type. Optional.
   * @member {Array.<Number>} prizes
   */
  exports.prototype.prizes = undefined;

  /**
   * Direct project identifier.  The challenge will be placed in this Direct project. Optional.
   * @member {Number} projectId
   */
  exports.prototype.projectId = undefined;

  /**
   * Will submissions be publically visible when the challenge ends? Optional.
   * @member {Boolean} submissionVisibility
   */
  exports.prototype.submissionVisibility = undefined;

  /**
   * How many submissions can each submitter submit? Optional.
   * @member {Number} maxNumOfSubmissions
   */
  exports.prototype.maxNumOfSubmissions = undefined;

  /**
   * Set the challenge to be a private task. Only allowed for First2Finish and Design First2Finish. Optional.
   * @member {Boolean} task
   */
  exports.prototype.task = undefined;

  /**
   * Preregistered users for private task, only valid when task is true. Optional.
   * @member {Array.<String>} assignees
   */
  exports.prototype.assignees = undefined;

  /**
   * The copilot id to set. Optional.
   * @member {Number} copilotId
   */
  exports.prototype.copilotId = undefined;

  /**
   * The copilot fee for the copilot. Optional.
   * @member {Number} copilotFee
   */
  exports.prototype.copilotFee = undefined;

  /**
   * Users that failed preregistering, including the reason. This is used in the response only. Optional.
